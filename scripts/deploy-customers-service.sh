...
oc label dc/customers-database app.openshift.io/runtime=postgresql --overwrite && \
oc label dc/customers-database app.kubernetes.io/part-of=customers-app --overwrite